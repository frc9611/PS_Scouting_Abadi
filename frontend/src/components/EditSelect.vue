<script setup lang="ts">
    ...
    function send(pr: any) {
        const form = ref({PR: pr - 1})
        emit('completed', form.value) // envia os dados
    }
                ...
                <div class="dados">
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                <th colspan="2" class="editData">
                                    <button class="EditData" @click="send(item.PR)">Editar Dados</button>
                                </th>
                            </tr>
                        </tbody>
                    </table>
